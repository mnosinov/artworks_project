"""
Django settings for artworks_project project.
...
ROOT_URLCONF = 'artworks_project.urls'
...
WSGI_APPLICATION = 'artworks_project.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'artworks_project/static'),
]

MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_URL = '/media/'

# resize image on upload - django_resized lib - for ResizedImageField
